...
components_dir = r"c:\Users\dhanu\OneDrive\Desktop\8Th sem\city\react-ui\src\components"
...
# Shared code components file
shared = """import React from 'react';
...
with open(f"{components_dir}/shared.jsx", "w", encoding="utf-8") as f:
    f.write(shared)

print("Split script ready. I am skipping breaking apart the massive App.jsx via script to avoid breaking references, and instead generating Auth logic.")
